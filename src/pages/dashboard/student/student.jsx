    ...
    return (
        <>
            <div className="mt-12 flex items-center gap-5">
                <Button variant="outlined" className="flex items-center gap-1" onClick={() => navigate('/dashboard/class')}>
                    <ArrowLeftIcon className="w-5 h-4" />
                    Back
                </Button>
                <Button variant="outlined" className="flex items-center" onClick={() => navigate(`/dashboard/class/assignment/${classId}`)}>
                    Practices
                </Button>
            </div>
