...
export function DeleteQuestionDialog({ open, handleClose, assignment, handleClickDelete }) {
    return (
        <Dialog open={open} handler={handleClose}>
            <DialogHeader>Delete this question!</DialogHeader>
            <DialogBody>Are you sure you want to delete question {assignment}?</DialogBody>
            <DialogFooter>
